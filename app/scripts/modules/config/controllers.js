        ...
        this.add_new_module_permission = function (mdl) {
          ...
          $scope.populateBranchAddress = function (isAddressAttached) {
            if(isAddressAttached) {
              $scope.cc.addBranch.addresses = add.branchBean.addresses;
              $scope.cc.addBranch.addresses[0].startDate = moment().format('DD/MM/YYYY h:mm:ss');
            } else {
          ...
          // this.addBranch.startDate = new Date();
           if(this.addBranch.branchId == 0) {
             this.addBranch.startDate = moment().format('DD/MM/YYYY h:mm:ss');
           }
          var branchBean = {}
...
//:TODO
        ...
        $scope.setBranch = function(selected){
          ...
          if(selected.addresses) {
            ...
            $scope.cc.addBranch.addresses = null;
          }
        }
